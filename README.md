...
```shell
git clone https://github.com/AlexWuYh/qubtTemplate
```
...
`hugo.yaml`:
```yaml
baseURL: 'https://AlexWuYh.github.io/qubtTemplate'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/AlexWuYh/qubtTemplate
  - link: https://github.com/AlexWuYh/qubtTemplate#readme
...
`https://AlexWuYh.github.io/qubtTemplate`